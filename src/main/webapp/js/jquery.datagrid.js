...
(function($) {
	...
	function _a6(_a7, _a8) {
		...
		_b1.find("div.datagrid-cell").removeClass(
		...
		function _ba() {
			...
			$.map(_c4, function(_c5) {
				...
				if (String(col.width || "").indexOf("%") >= 0) {
					var _c6 = $.parser.parseValue("width", col.width, dc.view,
							_b7.scrollbarSize)
							- col.deltaWidth;
					if (_c6 > 0) {
						col.boxWidth = _c6;
		...
		function _1e(_cf) {
			...
			function _d2(_d3) {
				...
				if (_d3 == "header") {
					...
					_cc.finder.getTr(_c9, 0, _d3).find(
							"td[field=\"" + _cf + "\"] div.datagrid-cell")
							.each(function() {
								var w = _d5($(this));
								if (_d4 < w) {
									_d4 = w;
				...
				return _d4;
				function _d5(_d6) {
					return _d6.is(":visible") ? _d6._outerWidth() : tmp.html(
							_d6.html())._outerWidth();
				}
				;
			}
			;
	...
	function _8e(_117, _118) {
		...
		opts.finder.getTr(_117, _119.highlightIndex).removeClass(
				"datagrid-row-over");
	...
	function _11e(_12a, _12b) {
		...
		opts.finder.getTr(_12a, "", "selected").removeClass(
	...
	function _95(_134, _135, _136) {
		...
		var tr = opts.finder.getTr(_134, _135).removeClass(
	...
	function _128(_139, _13a) {
		...
		var bck = opts.finder.getTr(_139, "", "allbody").addClass(
	...
	function _12e(_13c, _13d) {
		...
		var dc = _13e.dc;
		var hck = dc.header1.add(dc.header2).find("input[type=checkbox]");
		var bck = opts.finder.getTr(_13c, "", "checked").removeClass(
				"datagrid-row-checked").find(
				"div.datagrid-cell-check input[type=checkbox]");
	...
	function _192(_193, _194) {
		...
		var tr = opts.finder.getTr(_193, (_194.index != undefined ? _194.index
				: _194.id), _194.type);
		if (!tr.length) {
			return;
		}
			...
			return {
				...
				getValue : function(_1a4) {
					if (isA(_1a4, name)) {
						...
						if (opts.multiple) {
							return $(_1a4)[name]("getValues").join(
									opts.separator);
						} else {
	...
	var _1a9 = $
			.extend(
					{},
					_19b([ "text", "textbox", "numberbox", "numberspinner",
	...
	$.fn.datagrid.methods = {
		...
		updateRow : function(jq, _1e5) {
			return jq
					.each(function() {
						var opts = $.data(this, "datagrid").options;
						opts.view.updateRow.call(opts.view, this, _1e5.index,
								_1e5.row);
					});
		},
	...
	$.fn.datagrid.parseOptions = function(_1f1) {
		...
		return $.extend({}, $.fn.panel.parseOptions(_1f1), $.parser
				.parseOptions(_1f1, [ "url", "toolbar", "idField", "sortName",
	...
	$.fn.datagrid.parseData = function(_1f2) {
		...
		var _1f3 = t.datagrid("getColumnFields", true).concat(
	...
	var _1f4 = {
		...
		onAfterRender : function(_237) {
			...
			if (opts.showFooter) {
				var _239 = $(_237).datagrid("getPanel").find(
						"div.datagrid-footer");
				_239
						.find(
					...
					$.fn.panel.defaults,
					{
						...
						finder : {
							getTr : function(_242, _243, type, _244) {
								...
								if (_244 == 0) {
									var tr1 = opts.finder.getTr(_242, _243,
											type, 1);
									var tr2 = opts.finder.getTr(_242, _243,
											type, 2);
									return tr1.add(tr2);
								} else {
									if (type == "body") {
										var tr = $("#" + _245.rowIdPrefix + "-"
												+ _244 + "-" + _243);
										if (!tr.length) {
											tr = (_244 == 1 ? dc.body1
													: dc.body2)
										...
										if (type == "footer") {
											return (_244 == 1 ? dc.footer1
													: dc.footer2)
													.find(">table>tbody>tr[datagrid-row-index="
															+ _243 + "]");
										} else {
											if (type == "selected") {
												return (_244 == 1 ? dc.body1
														: dc.body2)
