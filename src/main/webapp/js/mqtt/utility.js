...
function connect() {
  var hostname = "10.16.44.112";//document.getElementById("hostInput").value;
  var port = "8083";//document.getElementById("portInput").value;
  var clientId = "chengzg3";//document.getElementById("clientIdInput").value;

  var path = "";//document.getElementById("pathInput").value;
  var user = "order-admin";//document.getElementById("userInput").value;
  var pass = "admin";//document.getElementById("passInput").value;
  var keepAlive = 60;//Number(document.getElementById("keepAliveInput").value);
  var timeout = 1000;//Number(document.getElementById("timeoutInput").value);
  ...
  var lastWillRetain = false;//document.getElementById("lwRetainInput").checked;
...
function subscribe() {
  var topic = "chengzgtest";//document.getElementById("subscribeTopicInput").value;
  var qos = 1;//document.getElementById("subscribeQosInput").value;
