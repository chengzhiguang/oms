...
<div style="padding:80px 60px;height: 260px;">
    ...
    <table class="tableForm"  cellspacing="8">
        <tr  align="right">
            <th>商铺标识：</th>
            <td><input id="storeCode" name="storeCode" class="easyui-textbox" style="width:200px;height:30px" value="${storeInfo.storeCode}" readonly="readonly"></td>
        </tr>
        <tr  align="right">
            <th>商铺名称：</th>
            <td><input id="storeName" name="storeName" class="easyui-textbox" style="width:200px;height:30px" value="${storeInfo.storeName}"></td>
        </tr>
        <tr  align="right">
            <th>每单运费：</th>
            <td><input id="storeFreight" name="storeFreight" style="width:200px;height:30px" value="${storeInfo.storeFreight}" onkeyup="javascript:checknum(this);"></td>
        </tr>
        <tr>
            <th></th>
