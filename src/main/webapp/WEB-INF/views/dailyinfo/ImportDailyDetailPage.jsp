...
<div style="padding:80px 60px;height: 260px;">
    ...
    <form  id="import_form" method="post" enctype="multipart/form-data">
        <input type="hidden" id="dailyCode" name="dailyCode" value="${dailyInfo.code}" />
        <table class="tableForm"  cellspacing="8">
            <tr>
                ...
                <td>
                    <input id="dailyDate" name="dailyDate" class="easyui-textbox" style="width:200px;height:30px" value="${dailyInfo.dateStr}" readonly="readonly">
                    <%--<input class="easyui-datebox" style="width:145px" id="dailyDate" name="dailyDate" data-options="formatter:myformatter,parser:myparser"></input>--%>
...
<script type="text/javascript">
    $('#s_dufrtEnddate').datebox('setValue',currentTime);
    function submit() {
        $("#import_form").ajaxSubmit({
            type:"post",
            async : false,
            cache : false,
            url: contextPath+'/page/dailyinfo/importDailyDetail',
